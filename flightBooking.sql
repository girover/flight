...
CREATE TABLE `route` (
  ...
  `FromAirportCode` char(3) NOT NULL,
...
INSERT INTO `airline` (`AirlineCode`, `Name`) 
        VALUES ('TAEGKX', 'Alaska Airline'),
               ('BRITAL', 'British Airline'),
               ('DANIAL', 'Danish Airline');


INSERT INTO `airport` (`AirportCode`, `Name`, `CityID`) 
        VALUES ('CPH', 'Copenhagen Airport, Kastrup', 3315),
               ('BLL', 'Billund Airport', 4080),
               ('OXF', 'London Oxford Airport', 498);


INSERT INTO `plane` (`planeID`, `Name`, `AirlineCode`, `Seats`, `Class`) 
        VALUES (NULL, 'Plane HDG-FSY', 'DANIAL', 150, 'economic'),
               (NULL, 'Plane ASD-VGD', 'DANIAL', 70, 'business'),
               (NULL, 'Plane BRT-125', 'BRITAL', 100, 'economic');


INSERT INTO `route` (`RouteID`, `FromAirportCode`, `ToAirportCode`, `PlaneID`, `Distance`, `Duration`) 
        VALUES (NULL, 'BLL', 'CPH', 1, 235, 125),
               (NULL, 'CPH', 'BLL', 1, 235, 125),
               (NULL, 'CPH', 'OXF', 2, 1250, 180);


INSERT INTO `flight` (`flightID`, `RouteID`, `DepartureTime`, `ArrivalTime`, `TicketPrice`) 
        VALUES (NULL, 1, '2022-12-01 12:45:00', '2022-12-01 15:10:00', 325),
               (NULL, 2, '2022-12-01 20:00:00', '2022-12-01 22:25:00', 325),
               (NULL, 3, '2022-12-02 12:00:00', '2022-12-02 15:00:00', 725);


INSERT INTO `passenger` (`PassengerID`, `FirstName`, `LastName`, `Birthdate`, `Phone`, `Email`) 
        VALUES (NULL, 'Sandi', 'Andersen', '1990-01-01', '42123456', 'sandi@email.com'),
               (NULL, 'Jensen', 'Brandt', '1990-02-01', '42654321', 'jensen@email.com'),
               (NULL, 'Martin', 'Bust', '1991-03-11', '42111111', 'martin@email.com'),
               (NULL, 'Pipi', 'Eriksen', '1992-03-08', '42222222', 'pipi@email.com'),
               (NULL, 'Ruby', 'Eriksen', '1990-03-05', '42333333', 'ruby@email.com'),
               (NULL, 'Rasmus', 'Krak', '1995-03-03', '42444444', 'rasmus@email.com');


INSERT INTO `client` (`ClientID`, `FirstName`, `LastName`, `Phone`, `Email`) 
        VALUES (NULL, 'Georg', 'Madsen', '42999999', 'georg@email.com'),
               (NULL, 'Luna', 'Johansen', '42888888', 'luna@email.com');


INSERT INTO `order` (`OrderID`, `ClientID`, `OrderTime`) 
        VALUES (NULL, 1, NOW()),
               (NULL, 2, NOW());


INSERT INTO `ticket` (`ticketID`, `PassengerID`, `FlightID`, `SeatNo`, `OrderedAt`, `OrderID`) 
...
(4080, 'Billund', 'DNK', 'Midtjylland', 15020);
